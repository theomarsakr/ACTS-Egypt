  ...
  return (
    <div className="relative shrink-0">
      ...
      <select
        ...
        className="appearance-none rounded-xl border border-gray-300 bg-gray-50 pl-[4.5rem] pr-9 py-3 text-base pointer-fine:text-[14px] font-semibold text-navy outline-none focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/20 transition cursor-pointer max-w-[15rem]"
      >
        {options.map((o) => (
